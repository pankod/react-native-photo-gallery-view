...
export class DetailComponent extends PureComponent {
    render() {
        return (React.createElement(Common.Consumer, null, (context) => (React.createElement(BlurImage, { style: { margin: 5 }, resizeMethod: context.detailImageResizeMethod, resizeMode: context.detailImageResizeMode, source: { uri: context.showingImage && context.showingImage.photo }, thumbnail: { uri: context.showingImage && context.showingImage.thumb } }))));
    }
}
